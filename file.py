...
if uploaded:
    ...
    st.write(
    """
- JPG: 写真や連続トーン画像の保存で使われ、非可逆圧縮によりファイルサイズを小さくできます。
- PNG: 図やアイコンなど、透明背景や可逆圧縮が必要な場合に使われます。
- GIF: アニメーションや256色以下の画像で使われることが多い形式です。
- BMP: 可逆ではあるものの非圧縮のため、主にWindows環境でのラフな保存に利用されます。
    """
)
